  ...
  <v-container fluid class="fill-height pa-0">
    <v-row class="fill-height ma-0">
      ...
      <v-col cols="12" sm="12" class="pa-4">
        <v-card class="fill-height" elevation="2" hover to="/study">
      ...
      <v-col cols="12" sm="6" class="pa-4">
        <v-card class="fill-height" elevation="2" hover to="/wordlist">
          <v-card-item class="fill-height d-flex flex-column justify-center">
      ...
      <!-- 考试卡片 -->
      <v-col cols="12" sm="6" class="pa-4">
        <v-card class="fill-height" elevation="2" hover to="/test">
          <v-card-item class="fill-height d-flex flex-column justify-center">
      ...
      <!-- 收藏卡片 -->
      <v-col cols="12" sm="6" class="pa-4">
        <v-card class="fill-height" elevation="2" hover to="/important">
          <v-card-item class="fill-height d-flex flex-column justify-center">
      ...
      <!-- 错题集卡片 -->
      <v-col cols="12" sm="6" class="pa-4">
        <v-card class="fill-height" elevation="2" hover to="mistakes">
          <v-card-item class="fill-height d-flex flex-column justify-center">
